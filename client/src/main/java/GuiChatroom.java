...
public class GuiChatroom extends JPanel {
    ...
    btnSend.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        if (chatroomModel.getToUser().getUserType() == User.UserType.human) {
          ...
          ListModelHelper.addToModel(listChatModel,
          ...
          switch (parts[0]) {
            ...
            case ProtocolTags.SHOW_BOOKINGS_TAG:
              ...
              break;
            default:
              ListModelHelper.addToModel(listChatModel, "Error: Command '" + parts[0] +"' not supported.");
              break;
          }
        }
  ...
  private void showHelpText(DefaultListModel<String> listChatModel) {
    ListModelHelper.addToModel(listChatModel, "Available commands:");
    ListModelHelper.addToModel(listChatModel, "1) show-open-slots <date> " +
        "e.g. show-open-slots 2018-03-18");
    ListModelHelper.addToModel(listChatModel, "2) book-slot <date> <time> " +
        "e.g. book-slot 2018-03-18 19:30");
    ListModelHelper.addToModel(listChatModel, "3) show-bookings <date> " +
        "e.g. show-bookings 2018-03-18");
    String divider = new String(new char[130]).replace('\0', '-');
    ListModelHelper.addToModel(listChatModel, divider);
  }
